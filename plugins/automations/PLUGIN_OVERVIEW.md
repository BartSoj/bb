...
Scripts run on the machine that hosts the bb server, in the project's directory when that machine has it. Agent runs use the providers you already have installed.
